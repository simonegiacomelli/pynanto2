...
ClipboardItemData = Awaitable[ClipboardItemDataType]
...
class Directory:
    name: str
    path: str
    def getFilesAndDirectories(self) -> Awaitable[Sequence[File | Directory]]: ...
    def getFiles(self, recursiveFlag: bool | None = false) -> Awaitable[Sequence[File]]: ...
...
class SourceBuffer(EventTarget):
    ...
    @overload
    def appendBufferAsync(self, data: ArrayBuffer) -> Awaitable[None]: ...
    @overload
    def appendBufferAsync(self, data: ArrayBufferView) -> Awaitable[None]: ...
    def abort(self): ...
    def remove(self, start: float, end: float): ...
    def removeAsync(self, start: float, end: float) -> Awaitable[None]: ...
...
class MediaStreamTrack(EventTarget):
    ...
    def applyConstraints(self, constraints: MediaTrackConstraints | None = None) -> Awaitable[None]: ...
...
class WindowClient(Client):
    ...
    def navigate(self, url: USVString) -> Awaitable[WindowClient]: ...
...
class VRDisplay(EventTarget):
    ...
    def requestPresent(self, layers: Sequence[VRLayer]) -> Awaitable[None]: ...
    def exitPresent(self) -> Awaitable[None]: ...
...
class PaymentResponse:
    ...
    payerEmail: str | None
    payerPhone: str | None
    def complete(self, result: PaymentComplete | None = "unknown") -> Awaitable[None]: ...
...
class PresentationRequest(EventTarget):
    ...
    def startWithDevice(self, deviceId: str) -> Awaitable[PresentationConnection]: ...
...
class RTCPeerConnection(EventTarget):
    ...
    @overload
    def createOffer(self, options: RTCOfferOptions | None = None) -> Awaitable[RTCSessionDescriptionInit]: ...
    @overload
    def createAnswer(self, options: RTCAnswerOptions | None = None) -> Awaitable[RTCSessionDescriptionInit]: ...
    @overload
    def setLocalDescription(self, description: RTCSessionDescriptionInit) -> Awaitable[None]: ...
    @overload
    ...
    @overload
    def addIceCandidate(self, candidate: RTCIceCandidateInit | RTCIceCandidate | None) -> Awaitable[None]: ...
    ...
    @overload
    def createOffer(self, successCallback: RTCSessionDescriptionCallback, failureCallback: RTCPeerConnectionErrorCallback, options: RTCOfferOptions | None = None) -> Awaitable[None]: ...
    @overload
    ...
    @overload
    def setLocalDescription(self, description: RTCSessionDescriptionInit, successCallback: VoidFunction, failureCallback: RTCPeerConnectionErrorCallback) -> Awaitable[None]: ...
    @overload
    ...
    @overload
    def addIceCandidate(self, candidate: RTCIceCandidate, successCallback: VoidFunction, failureCallback: RTCPeerConnectionErrorCallback) -> Awaitable[None]: ...
    @overload
    def getStats(self, selector: MediaStreamTrack | None, successCallback: RTCStatsCallback, failureCallback: RTCPeerConnectionErrorCallback) -> Awaitable[None]: ...
...
class CustomElementRegistry:
    ...
    def whenDefined(self, name: str) -> Awaitable[None]: ...
...
class Clients:
    def matchAll(self, options: ClientQueryOptions | None = None) -> Awaitable[Sequence[Client]]: ...
...
class Cache:
    def match(self, request: RequestInfo, options: CacheQueryOptions | None = None) -> Awaitable[Response]: ...
    def matchAll(self, request: RequestInfo | None = None, options: CacheQueryOptions | None = None) -> Awaitable[Sequence[Response]]: ...
    ...
    def delete(self, request: RequestInfo, options: CacheQueryOptions | None = None) -> Awaitable[bool]: ...
    def keys(self, request: RequestInfo | None = None, options: CacheQueryOptions | None = None) -> Awaitable[Sequence[Request]]: ...
...
class VRServiceTest:
    def attachVRDisplay(self, id: str) -> Awaitable[VRMockDisplay]: ...
    def attachVRController(self, id: str) -> Awaitable[VRMockController]: ...
...
class RTCRtpSender:
    ...
    def setParameters(self, parameters: RTCRtpParameters | None = None) -> Awaitable[None]: ...
...
class MediaDevices(EventTarget):
    ...
    def getUserMedia(self, constraints: MediaStreamConstraints | None = None) -> Awaitable[MediaStream]: ...
    def getDisplayMedia(self, constraints: DisplayMediaStreamConstraints | None = None) -> Awaitable[MediaStream]: ...
...
class CredentialsContainer:
    def get(self, options: CredentialRequestOptions | None = None) -> Awaitable[Credential | None]: ...
    def create(self, options: CredentialCreationOptions | None = None) -> Awaitable[Credential | None]: ...
...
class Navigator(NavigatorID, NavigatorLanguage, NavigatorOnLine, NavigatorContentUtils, NavigatorStorageUtils, NavigatorConcurrentHardware, NavigatorStorage, NavigatorAutomationInformation, NavigatorGeolocation, NavigatorGPU):
    ...
    def getVRDisplays(self) -> Awaitable[Sequence[VRDisplay]]: ...
    ...
    def requestMIDIAccess(self, options: MIDIOptions | None = None) -> Awaitable[MIDIAccess]: ...
...
class PushManagerImpl:
    def subscribe(self, options: PushSubscriptionOptionsInit | None = None) -> Awaitable[PushSubscription]: ...
    def getSubscription(self) -> Awaitable[PushSubscription | None]: ...
    def permissionState(self, options: PushSubscriptionOptionsInit | None = None) -> Awaitable[PushPermissionState]: ...
...
class MediaCapabilities:
    def decodingInfo(self, configuration: MediaDecodingConfiguration) -> Awaitable[MediaCapabilitiesInfo]: ...
    def encodingInfo(self, configuration: MediaEncodingConfiguration) -> Awaitable[MediaCapabilitiesInfo]: ...
...
class FontFaceSet(EventTarget):
    ...
    def load(self, font: str, text: str | None = " ") -> Awaitable[Sequence[FontFace]]: ...
...
class MediaKeys:
    ...
    def setServerCertificate(self, serverCertificate: BufferSource) -> Awaitable[None]: ...
    def getStatusForPolicy(self, policy: MediaKeysPolicy | None = None) -> Awaitable[MediaKeyStatus]: ...
...
class GamepadServiceTest:
    ...
    def addGamepad(self, id: str, mapping: GamepadMappingType, hand: GamepadHand, numButtons: int, numAxes: int, numHaptics: int) -> Awaitable[int]: ...
...
class RTCIdentityProviderRegistrar:
    ...
    hasIdp: bool
    def generateAssertion(self, contents: str, origin: str, options: RTCIdentityProviderOptions | None = None) -> Awaitable[RTCIdentityAssertionResult]: ...
    def validateAssertion(self, assertion: str, origin: str) -> Awaitable[RTCIdentityValidationResult]: ...
...
class ServiceWorkerContainer(EventTarget):
    ...
    def register(self, scriptURL: USVString, options: RegistrationOptions | None = None) -> Awaitable[ServiceWorkerRegistration]: ...
...
class ServiceWorkerRegistration(EventTarget):
    ...
    def showNotification(self, title: str, options: NotificationOptions | None = None) -> Awaitable[None]: ...
    def getNotifications(self, filter: GetNotificationOptions | None = None) -> Awaitable[Sequence[Notification]]: ...
...
class Permissions:
    def query(self, permission: object) -> Awaitable[PermissionStatus]: ...
    def revoke(self, permission: object) -> Awaitable[PermissionStatus]: ...
...
class HTMLMediaElement(HTMLElement):
    ...
    def seekToNextFrame(self) -> Awaitable[None]: ...
...
class WakeLock:
    def request(self, type: WakeLockType) -> Awaitable[WakeLockSentinel]: ...
...
class ImageCapture:
    def takePhoto(self, photoSettings: PhotoSettings | None = None) -> Awaitable[Blob]: ...
...
class Bluetooth(EventTarget, BluetoothDeviceEventHandlers, CharacteristicEventHandlers, ServiceEventHandlers):
    ...
    def requestDevice(self, options: RequestDeviceOptions) -> Awaitable[BluetoothDevice]: ...
